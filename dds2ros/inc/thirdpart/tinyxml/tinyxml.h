...
#ifndef TIXML_API
#define TIXML_API __declspec(dllimport)
#endif

class TIXML_API TiXmlDocument;
class TIXML_API TiXmlElement;
class TIXML_API TiXmlComment;
class TIXML_API TiXmlUnknown;
class TIXML_API TiXmlAttribute;
class TIXML_API TiXmlText;
class TIXML_API TiXmlDeclaration;
class TIXML_API TiXmlParsingData;
