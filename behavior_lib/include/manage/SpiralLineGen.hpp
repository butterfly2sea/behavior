...
namespace zyzn{
    namespace manage{
        /**
         * @brief 螺旋线航线生成 螺旋线航线生成，用于国科大详查点航线生成，以点为中心，最大搜索半径、搜索间隔为参数生成螺旋航线
         * @author zyzn
        */
        ...
        public:
            ...
            /**
             * @brief 生成螺旋航线 生成螺旋航线，以点为中心，最大搜索半径、搜索间隔为参数生成螺旋航线
            ...
            */
            ...
            /**
             * @brief 获取总航点数 最大搜索半径、搜索间隔为参数计算可生成螺旋航线的航点数，累计每圈的航点数
             * @param R in 半径
             * @param intv in 扫描间隔
             * @return int 总航点数
            */
            ...
            /**
             * @brief 获取每圈的航点数 搜索半径、搜索间隔为参数计算每圈的航点数
             * @param R in 半径
             * @param intv in 扫描间隔
             * @param scale in 缩放比例
             * @return int 每圈的航点数
