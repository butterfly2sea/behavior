...
constexpr const char *INFO_GPIO_STATUS = "inner/information/gpio_status"; // （待补充进文档）
constexpr const char *OUTER_VEHICLE_STATE = "outer/information/simple_vehicle"; // （待补充进文档）
constexpr const char *OUTER_TASK_STAGE = "outer/set/task_stage";// （待补充进文档）
...
constexpr const char *SET_SPEED = "inner/set/form_spd"; // 设置编队航速
